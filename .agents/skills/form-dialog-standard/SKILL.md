...
4. Keep project naming unchanged: `dialogVisible`, `formRef`, `form`, `rules`, `isSubmitLoading`, `isEdit`, and `row`.
5. Reuse nearby implementation patterns before inventing new abstractions.
