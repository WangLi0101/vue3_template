...
const getMenuRank = (menu: AppMenu): number =>
  typeof menu.meta.rank === 'number' && Number.isFinite(menu.meta.rank) ? menu.meta.rank : DEFAULT_RANK
...
const resolveAutoRedirect = (children: AppMenu[], parentPath: string): RouteRecordRaw['redirect'] => {
